 ...
 */
public class MyTripsFragment extends android.app.Fragment {
    View view;
                ...
                case Dialog.BUTTON_POSITIVE: {
                    ...
                    ((Activity)context).runOnUiThread(new Runnable() {
                                                          ...
                                                          public void run() {
                                                              ...
                                                              intent.putExtra(ContactsContract.Intents.Insert.NAME, tmpTrip.getCostumerName());
                                                              intent.putExtra(ContactsContract.Intents.Insert.PHONE,tmpTrip.getCostumerTel());
                                                              intent.putExtra(ContactsContract.Intents.Insert.EMAIL, tmpTrip.getCostumerEmail());
